...
app.post("/ajaxmessage", function (req, res) {
  // var data = require("./public/guestbook.json");
  //if I have this json file required in order to push data there
  var username = req.body.username;
  var country = req.body.country;
  var message = req.body.message;
  //it does not show this text under send box
  res.send("Thank YOU: " + username + " from " + country + " Following message: " + message + " is seen!");
});
/*if you move this ending tag down this will work and save data to json file,
but then text above does not show...
  data.push({
    'username': req.body.username,
    'message': req.body.message,
    'country': req.body.country,
